...
public class FirstStartActivity extends Activity {
	...
	private void init() {
		...
		alPages.add(inflater.inflate(R.layout.firststartpage4, null));
		alPages.add(inflater.inflate(R.layout.firststartpage5, null));
		...
		View view = alPages.get(4);
		view.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				startActivity(new Intent(FirstStartActivity.this, MainHomeActivityGroup.class));
