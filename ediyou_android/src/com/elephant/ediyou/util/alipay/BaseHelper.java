...
import com.elephant.ediyou.activity.MyAccountPrepaidActivity;
...
public class BaseHelper {
	...
	public static ProgressDialog showProgress(Context context, CharSequence title, CharSequence message, boolean indeterminate, boolean cancelable) {
		...
		dialog.setOnCancelListener(new MyAccountPrepaidActivity.AlixOnCancelListener((Activity) context));
