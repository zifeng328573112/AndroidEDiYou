 ...
 *
 */
public class MyDateTimePickerDialog extends Dialog implements android.view.View.OnClickListener {
	...
	public MyDateTimePickerDialog(Context context, final int START_YEAR, final int END_YEAR, OnDateTimeSetListener callBack) {
		...
		View view = inflater.inflate(R.layout.my_date_time_choice_layout, null);
